    ...
    <section className="rounded-xl border border-[#c89d66] bg-[#f3ddba] p-6 shadow-sm">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
        <div className="rounded-lg border border-[#c89d66] bg-[#f8fbff] p-4">
          <label className="mb-2 block text-sm font-medium text-[#14263a]">{t("dashboard.search.sku")}</label>
        ...
        <div className="rounded-lg border border-[#c89d66] bg-[#f8fbff] p-4">
          <label className="mb-2 block text-sm font-medium text-[#14263a]">{t("dashboard.search.shipment")}</label>
          <div className="flex gap-2">
        ...
        <div className="rounded-lg border border-[#c89d66] bg-[#f8fbff] p-4">
          <label className="mb-2 block text-sm font-medium text-[#14263a]">{t("dashboard.search.weight")}</label>
          <div className="flex gap-2">
